/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 6d61585c66a4dc9f0d33acad774a2708)
...
declare namespace Cloudflare {
	...
	interface Env {
		RESEND_FROM_EMAIL: "do_not_reply@auth.simplysell.ph";
		...
		AI: Ai;
		ASSETS: Fetcher;
		EXAMPLE_WORKFLOW: Workflow<Parameters<import("./worker").ExampleWorkflow['run']>[0]['payload']>;
	}
}
